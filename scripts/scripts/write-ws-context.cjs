...
const dest = path.resolve(__dirname, '..', '..', 'src', 'contexts', 'WsContext.jsx');
const code = `import React, { createContext, useContext, useEffect, useMemo, useRef, useState } from 'react';
